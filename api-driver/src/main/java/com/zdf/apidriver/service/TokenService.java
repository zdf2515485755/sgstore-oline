...
public class TokenService
{
    ...
    public ResponseResult refreshToken(String refreshTokenSrc)
    {
        ...
        //生成新的双token
        String accessTokenKey = RedisKeyUtils.generateTokenKey(phone, IdentityConstant.DRIVER_IDENTITY, TokenConstant.ACCESS_TOKEN_TYPE);
        String accessToken = JwtUtils.generatorToken(phone, IdentityConstant.DRIVER_IDENTITY, TokenConstant.ACCESS_TOKEN_TYPE);
        String refreshToken = JwtUtils.generatorToken(phone, IdentityConstant.DRIVER_IDENTITY, TokenConstant.REFRESH_TOKEN_TYPE);
